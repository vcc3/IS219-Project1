        ...
        <div class="download-section">
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2 col-sm-8 col-sm-offset-2">
                  ...
                  <p>Delaware Cemetery Association, Dingmans Ferry ,PA(Summer, 2014)</p>
                    <ul>
                 ...
                 <p>The Pet Spa and Resort, Franklin NJ(August 2016-Current)</p>
                    <ul>
            ...
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2 col-sm-8 col-sm-offset-2">
                 ...
                 <p>Programming languages worked in:</p>
                   ...
                   <p>Usage of Git, and GitHub and Trello </p>
                   <p>Able to adapt in different working environments.</p>
                   <p> Communication with others to clearly depict what is needed and must be done for a project to be completed.<p>
   ...
   <!-- Contact Section ------------------------------------------------------------------------------>
     <section id="contact" class="content-section text-center">
        <div class="download-section">
            <div class="container">
                ...
                <br>
                <br>
                <p> The button below will redirect to my Github page.</p>
                <ul class="list-inline banner-social-buttons">
                   
                    <li>
                        <a href="https://github.com/vcc3" class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i> <span class="network-name">Github</span></a>
                    </li>
                </ul>
                          ...
                          <table width="450px">
                            ...
                            <tr>
                             ...
                             <td valign="top">
                              ...
                              <label for="comments">Subject Body *</label>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright &copy; My Website for School 2017</p>
        </div>
    </footer>
